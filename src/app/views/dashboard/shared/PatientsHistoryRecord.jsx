...
export default function PatientsHistoryRecord() {
    ...
    const handleClickOpen = (data) => {
        axios.get("http://localhost:3001/medicalrecord/" + data._id).then((res) => {
            console.log(res.data)
            setRecords(res.data)
        })
    ...
    return (
        <TableContainer component={Paper} sx={{ width: '70%', marginLeft: 'auto', marginRight: 'auto', marginTop: '5%', marginBottom: '5%' }}>
            <h1 style={{ textAlign: 'center' }}>Patients medical Records History</h1>
            <Table aria-label="simple table">
                <TableHead>
                    <TableRow>
                        ...
                        <TableCell align="center" style={customColumnStyle}>Medical Record details</TableCell>
                    ...
                    {lstusers.map((row) => (
                        ...
                        >
                            ...
                            <TableCell align="center">
                                <Fab sx={{ mr: 3 }} color="primary" aria-label="add" size="small" onClick={() => {
                                    handleClickOpen(row);
                                }}
                                >
                    ...
                    >
                        {records.map((row) => (
                            <ListItem button onClick={() => {
                                ...
                                <ListItemText primary={Moment(row.data.DateCreation).format('dddd MMM YYYY HH:mm ')} />
                            </ListItem>
