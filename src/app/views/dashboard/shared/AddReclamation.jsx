...
const CardRoot = styled(Card)(({ theme }) => ({
    //  marginBottom: '24px',
    margin: '30px',
    boxShadow: '-1px 1px 9px -2px rgba(0,0,0,0.95) !important',
...
export default function AddReclamation() {
    ...
    React.useEffect(() => {
        axios
            .get('https://tbibi.herokuapp.com/users/lstdoctors')
            .then((res) => {
                // lst = res.data
    ...
    return (
        ...
        >
            <StyledCard elevation={0}>
                <img
                    src="https://cdn.iconscout.com/icon/premium/png-256-thumb/claims-2021941-1705361.png"
                    width="100px"
                    alt="upgrade"
                />
                <Paragraph>
