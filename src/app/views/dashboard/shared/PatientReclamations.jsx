...
export default function PatientReclamations() {
    ...
    const handleDeleteClick = (data) => {
        console.log(data)
        axios
            .delete('https://tbibi.herokuapp.com/reclamations/' + data._id)
            .then((res) => {
                fetchreclamation()
            })
    ...
    const handleUpdateClick = () => {
        ...
        axios
            .put(
                'https://tbibi.herokuapp.com/reclamations/updateReclamationDescription/' +
                    selectedId,
                {
                    description: input,
                }
