...
export default function Symptoms() {
    ...
    const getSymptoms = async () => {
        const url = 'http://localhost:3001/symptoms'
    ...
    const getSpecialities = async (list) => {
        const url = 'http://localhost:3001/symptoms/speciality'
        const data = await axios.post(url, { symptoms: list })
        console.log(data.data)
        setSpecialities(data.data)
    }

    const getSelectedSymptoms = () => {
        let list = getSymptomsIds()
        getSpecialities(list)
    }
    return (
        <Root>
            <div
